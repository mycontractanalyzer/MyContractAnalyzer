...
faq = [
    ("Это действительно работает?", "Да. Мы используем современную нейросеть DeepSeek, специально настроенную на юридические тексты. Модель читает весь договор, а не выдёргивает ключевые слова."),
...
with cta_col2:
    if st.button("🚀 Начать сейчас", use_container_width=True):
        st.switch_page("pages/2_dashboard.py")