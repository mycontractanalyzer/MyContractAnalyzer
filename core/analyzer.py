...
2) «❗ Осторожно:» — красные риски; «🟡 Следует уточнить:» — жёлтые; в КАЖДОМ пункте этих разделов, где в ПРАВОВОЙ БАЗЕ нашлась подходящая статья, добавь строку «⚖️ Обоснование:» (номер + дословная цитата в кавычках). Если подходящей статьи в базе нет — НЕ добавляй строку «Обоснование» в этот пункт и никак не упоминай отсутствие нормы.
...
CITATION_TASK = """
ИСПОЛЬЗУЙ ПРАВОВУЮ БАЗУ НИЖЕ ПРИ АНАЛИЗЕ: каждый красный и жёлтый риск сопровождай
строкой «⚖️ Обоснование:» с номером статьи и её ДОСЛОВНОЙ формулировкой из базы.
Вне базы статьи не выдумывать.
